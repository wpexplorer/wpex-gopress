...
function wpex_mdm_register_widgets() {
	...
	wp_add_dashboard_widget( 'widget_wpexplorer_feed', esc_html__( 'WPExplorer Blog', 'wpex-gopress' ), 'wpex_dashboard_rss_box' );
	wp_add_dashboard_widget( 'widget_wdexplorer_feed', esc_html__( 'Web Design Blog', 'wpex-gopress' ), 'wde_dashboard_rss_box' );
}
